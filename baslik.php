...
<html>
<head>
<title>MOTOR SATIŞ SİTEMİZE HOŞ GELDİNİZ</title>
	...
	<div class="header">
		<div class="container">
				<div class="header-top">
					<div class="logo">
						<h1><a href="index.html">Super Bikes</a></h1>
					</div>
					<div class="phone">
					...
					<div class="navbar-header">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						  <ul class="nav navbar-nav cl-effect-16">
							...
							<li><a href="index.php?sayfa=bilgiler">About</a></li>
							 <li class="dropdown">
							  ...
							  <ul class="dropdown-menu">
								 <li><a href="services.php">Services1</a></li>
								<li><a href="services.php">Services2</a></li>
								<li><a href="services.php">Services3</a></li>
							  </ul>
							</li>
								<li><a href="index.php?sayfa=galeri">Gallery</a></li>
								<li><a href="index.php?sayfa=iletisim">Contact</a></li>
	                        ...
	                        <span class="glyphicon glyphicon-log-in"></span> GİRİŞ </button> 
	                       </li>
